...
public class MainServerProgram
{
    ...
    public static void Main(string[] args)
    {
        ...
        {
            // DLL Stuff
            DLLserver.Bind(new IPEndPoint(IPAddress.Parse("172.31.89.89"), 8887));
            DLLserver.Listen(10);
        ...
        IPEndPoint localEP = new IPEndPoint(IPAddress.Parse("172.31.89.89"), 8889);

        try
        {
            // TCP Stuff
            TCPserver.Bind(new IPEndPoint(IPAddress.Parse("172.31.89.89"), 8888));
            TCPserver.Listen(2);
